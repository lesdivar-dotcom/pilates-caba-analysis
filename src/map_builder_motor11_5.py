...
def color_datos(valor, minimo, maximo):
    """
    Escala relativa institucional:
        borgoña -> terracota -> arena -> verde

    Gris queda reservado para "sin dato".
    """
    ...
    if ratio < 0.25:
        return PALETA_DATOS[0]

    if ratio < 0.50:
        return PALETA_DATOS[1]

    if ratio < 0.75:
        return PALETA_DATOS[2]

    return PALETA_DATOS[3]
...
def main():
    ...
    print("MOTOR 11.5 — CARTOGRAFÍA TERRITORIAL UNIVERSAL")
    print("=" * 60)
